...
public class RgSkills implements Serializable {
    ...
    public RgSkills createdBy(String createdBy) {
    ...
    public RgSkills createdAt(Instant createdAt) {
    ...
    public RgSkills updatedBy(String updatedBy) {
    ...
    public RgSkills updatedAt(Instant updatedAt) {
