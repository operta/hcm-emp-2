...
public class RgFamilyRoles implements Serializable {
    ...
    public RgFamilyRoles createdBy(String createdBy) {
    ...
    public RgFamilyRoles createdAt(Instant createdAt) {
    ...
    public RgFamilyRoles updatedBy(String updatedBy) {
    ...
    public RgFamilyRoles updatedAt(Instant updatedAt) {
