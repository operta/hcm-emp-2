...
public class RgRegions implements Serializable {
    ...
    public RgRegions createdBy(String createdBy) {
    ...
    public RgRegions createdAt(Instant createdAt) {
    ...
    public RgRegions updatedBy(String updatedBy) {
    ...
    public RgRegions updatedAt(Instant updatedAt) {
