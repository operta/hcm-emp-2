...
public class EmEmpBankAccounts implements Serializable {
    ...
    public LeLegalEntities getIdBank() {
        return idBank;
    }

    public EmEmpBankAccounts idBank(LeLegalEntities leLegalEntities) {
        this.idBank = leLegalEntities;
        return this;
    }

    public void setIdBank(LeLegalEntities leLegalEntities) {
        this.idBank = leLegalEntities;
    }
