...
@Injectable()
export class EmpPersonalInfoPopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.employeeModalRef(component, new LeLegalEntities());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    employeeModalRef(component: Component, employee: LeLegalEntities): NgbModalRef {
