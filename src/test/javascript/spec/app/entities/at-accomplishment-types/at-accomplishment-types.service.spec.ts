...
describe('Service Tests', () => {
    ...
    describe('AtAccomplishmentTypes Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(AtAccomplishmentTypesService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/at-accomplishment-types';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return AtAccomplishmentTypes', () => {

                let entity: AtAccomplishmentTypes;
                service.find(123).subscribe((_entity: AtAccomplishmentTypes) => {
                    entity = _entity;
                });
