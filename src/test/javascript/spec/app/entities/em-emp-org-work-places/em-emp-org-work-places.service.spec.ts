...
describe('Service Tests', () => {
    ...
    describe('EmEmpOrgWorkPlaces Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(EmEmpOrgWorkPlacesService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/em-emp-org-work-places';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return EmEmpOrgWorkPlaces', () => {

                let entity: EmEmpOrgWorkPlaces;
                service.find(123).subscribe((_entity: EmEmpOrgWorkPlaces) => {
                    entity = _entity;
                });
