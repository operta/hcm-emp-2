...
describe('Service Tests', () => {
    ...
    describe('EmEmpInjuries Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(EmEmpInjuriesService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/em-emp-injuries';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return EmEmpInjuries', () => {

                let entity: EmEmpInjuries;
                service.find(123).subscribe((_entity: EmEmpInjuries) => {
                    entity = _entity;
                });
