...
describe('Service Tests', () => {
    ...
    describe('RgIdentificationTypes Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(RgIdentificationTypesService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/rg-identification-types';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return RgIdentificationTypes', () => {

                let entity: RgIdentificationTypes;
                service.find(123).subscribe((_entity: RgIdentificationTypes) => {
                    entity = _entity;
                });
