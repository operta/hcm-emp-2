...
describe('Service Tests', () => {
    ...
    describe('RgSkillGrades Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(RgSkillGradesService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/rg-skill-grades';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return RgSkillGrades', () => {

                let entity: RgSkillGrades;
                service.find(123).subscribe((_entity: RgSkillGrades) => {
                    entity = _entity;
                });
