...
describe('Service Tests', () => {
    ...
    describe('EmEmpFamilies Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(EmEmpFamiliesService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/em-emp-families';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return EmEmpFamilies', () => {

                let entity: EmEmpFamilies;
                service.find(123).subscribe((_entity: EmEmpFamilies) => {
                    entity = _entity;
                });
