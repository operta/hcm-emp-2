...
describe('Service Tests', () => {
    ...
    describe('EmInjuryTypes Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(EmInjuryTypesService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/em-injury-types';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return EmInjuryTypes', () => {

                let entity: EmInjuryTypes;
                service.find(123).subscribe((_entity: EmInjuryTypes) => {
                    entity = _entity;
                });
