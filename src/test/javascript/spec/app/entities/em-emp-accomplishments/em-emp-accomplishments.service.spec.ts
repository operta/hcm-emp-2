...
describe('Service Tests', () => {
    ...
    describe('EmEmpAccomplishments Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(EmEmpAccomplishmentsService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/em-emp-accomplishments';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return EmEmpAccomplishments', () => {

                let entity: EmEmpAccomplishments;
                service.find(123).subscribe((_entity: EmEmpAccomplishments) => {
                    entity = _entity;
                });
