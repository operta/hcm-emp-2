...
describe('Service Tests', () => {
    ...
    describe('RgFamilyRoles Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(RgFamilyRolesService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/rg-family-roles';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return RgFamilyRoles', () => {

                let entity: RgFamilyRoles;
                service.find(123).subscribe((_entity: RgFamilyRoles) => {
                    entity = _entity;
                });
