...
describe('Service Tests', () => {
    ...
    describe('OgOrgWorkPlaces Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(OgOrgWorkPlacesService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/og-org-work-places';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return OgOrgWorkPlaces', () => {

                let entity: OgOrgWorkPlaces;
                service.find(123).subscribe((_entity: OgOrgWorkPlaces) => {
                    entity = _entity;
                });
