...
describe('Service Tests', () => {
    ...
    describe('OgWorkPlaceTypes Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(OgWorkPlaceTypesService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/og-work-place-types';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return OgWorkPlaceTypes', () => {

                let entity: OgWorkPlaceTypes;
                service.find(123).subscribe((_entity: OgWorkPlaceTypes) => {
                    entity = _entity;
                });
