...
describe('Service Tests', () => {
    ...
    describe('OgOrganizations Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(OgOrganizationsService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/og-organizations';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return OgOrganizations', () => {

                let entity: OgOrganizations;
                service.find(123).subscribe((_entity: OgOrganizations) => {
                    entity = _entity;
                });
