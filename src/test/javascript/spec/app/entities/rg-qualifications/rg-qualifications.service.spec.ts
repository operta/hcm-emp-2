...
describe('Service Tests', () => {
    ...
    describe('RgQualifications Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(RgQualificationsService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/rg-qualifications';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return RgQualifications', () => {

                let entity: RgQualifications;
                service.find(123).subscribe((_entity: RgQualifications) => {
                    entity = _entity;
                });
