...
describe('Service Tests', () => {
    ...
    describe('EmEmpBankAccounts Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(EmEmpBankAccountsService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/em-emp-bank-accounts';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return EmEmpBankAccounts', () => {

                let entity: EmEmpBankAccounts;
                service.find(123).subscribe((_entity: EmEmpBankAccounts) => {
                    entity = _entity;
                });
