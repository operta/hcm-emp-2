...
describe('Service Tests', () => {
    ...
    describe('RgContactTypes Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(RgContactTypesService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/rg-contact-types';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return RgContactTypes', () => {

                let entity: RgContactTypes;
                service.find(123).subscribe((_entity: RgContactTypes) => {
                    entity = _entity;
                });
