...
describe('Service Tests', () => {
    ...
    describe('EmBorrowingTypes Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(EmBorrowingTypesService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/em-borrowing-types';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return EmBorrowingTypes', () => {

                let entity: EmBorrowingTypes;
                service.find(123).subscribe((_entity: EmBorrowingTypes) => {
                    entity = _entity;
                });
