...
describe('Service Tests', () => {
    ...
    describe('EmEmpBorrowings Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(EmEmpBorrowingsService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/em-emp-borrowings';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return EmEmpBorrowings', () => {

                let entity: EmEmpBorrowings;
                service.find(123).subscribe((_entity: EmEmpBorrowings) => {
                    entity = _entity;
                });
