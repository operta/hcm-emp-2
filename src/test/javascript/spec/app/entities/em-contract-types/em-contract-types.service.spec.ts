...
describe('Service Tests', () => {
    ...
    describe('EmContractTypes Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(EmContractTypesService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/em-contract-types';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return EmContractTypes', () => {

                let entity: EmContractTypes;
                service.find(123).subscribe((_entity: EmContractTypes) => {
                    entity = _entity;
                });
