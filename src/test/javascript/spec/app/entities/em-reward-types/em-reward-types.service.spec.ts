...
describe('Service Tests', () => {
    ...
    describe('EmRewardTypes Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(EmRewardTypesService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/em-reward-types';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return EmRewardTypes', () => {

                let entity: EmRewardTypes;
                service.find(123).subscribe((_entity: EmRewardTypes) => {
                    entity = _entity;
                });
